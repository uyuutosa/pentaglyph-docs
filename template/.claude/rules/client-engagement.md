...
## The 5 PEL templates that ship today (9–13)

- [`9_inception-deck.md`](../../docs/templates/9_inception-deck.md) — for `CHARTER.md`
- [`10_weekly-update.md`](../../docs/templates/10_weekly-update.md) — for `reports/<YYMMDD>/weekly.md`
- [`11_heartbeat.md`](../../docs/templates/11_heartbeat.md) — for `reports/<YYMMDD>/heartbeat.md` and `reports/narratives/`
- [`12_daci-decision.md`](../../docs/templates/12_daci-decision.md) — for `daci/`, archives to `decisions/` using `5_adr.md` (MADR)
- [`13_raid-entry.md`](../../docs/templates/13_raid-entry.md) — row format for `raid.md`

Templates 14 (PR/FAQ), 15 (Now/Next/Later), 16 (Kickoff) are planned for a follow-up release. Until shipped, follow the structure documented in the authoritative source URLs above and in each `client-engagement/<sub-dir>/README.md`.
