...
# Heartbeat Template (Type 11 / Basecamp Heartbeat + Amazon 6-pager prose discipline)

> **Copy to use**: `cp templates/11_heartbeat.md client-engagement/reports/<YYMMDD>/heartbeat.md`
> Recommended location: `client-engagement/reports/<YYMMDD>/heartbeat.md` (at cycle boundaries) · `client-engagement/reports/narratives/YYYY-MM-DD_<topic>.md` (ad-hoc strategic memos)
...
>
> **When to write it**: at every cycle boundary (typically every 4–6 weeks per `OPERATING-AGREEMENT.md`). Ad-hoc strategic memos (e.g., "should we pivot the scope?") use the same template, filed under `reports/narratives/`.
>
...
- previous Heartbeat — [`../reports/<YYMMDD-prev-cycle>/heartbeat.md`](../reports/)
