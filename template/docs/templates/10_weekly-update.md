...
# Weekly Update Template (Type 10 / Atlassian 4-block)

> **Copy to use**: `cp templates/10_weekly-update.md client-engagement/reports/<YYMMDD>/weekly.md`
...
>
> **Discipline**: brevity. The weekly is mechanical and scan-able. Save narrative for the cycle Heartbeat ([`11_heartbeat.md`](./11_heartbeat.md)). If you find yourself writing >1 page of weekly, those paragraphs probably belong in the Heartbeat.
>
