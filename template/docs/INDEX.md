...
- [`templates/0_default.md`](./templates/0_default.md) — fallback when none of 1–13 fit
...
- [`templates/9_inception-deck.md`](./templates/9_inception-deck.md) — Agile Inception Deck for `client-engagement/CHARTER.md` (PEL)
- [`templates/10_weekly-update.md`](./templates/10_weekly-update.md) — Atlassian 4-block weekly status (PEL)
- [`templates/11_heartbeat.md`](./templates/11_heartbeat.md) — Basecamp Heartbeat + Amazon 6-pager prose discipline (PEL)
- [`templates/12_daci-decision.md`](./templates/12_daci-decision.md) — DACI workflow that archives to MADR (PEL)
- [`templates/13_raid-entry.md`](./templates/13_raid-entry.md) — RAID log row format (PEL)
