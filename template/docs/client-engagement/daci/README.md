...
1. **Open**: Driver creates `YYYY-MM-DD-<slug>.md` from [`../../templates/12_daci-decision.md`](../../templates/12_daci-decision.md) with D/A/C/I roles assigned and the question stated.
...
- [`../../templates/12_daci-decision.md`](../../templates/12_daci-decision.md) — DACI template
