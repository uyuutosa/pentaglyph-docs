...
| --- | --- | --- | --- |
| `YYMMDD/weekly.md` | Atlassian "Priorities → Progress → Problems → Next" | Weekly | [`../../templates/10_weekly-update.md`](../../templates/10_weekly-update.md) |
| `YYMMDD/heartbeat.md` | Basecamp Heartbeat + Amazon 6-pager prose discipline | Every cycle (typically 4-6 weeks) | [`../../templates/11_heartbeat.md`](../../templates/11_heartbeat.md) |
| `narratives/YYYY-MM-DD_<topic>.md` | Amazon 6-pager (strategic memo) | Ad hoc | [`../../templates/11_heartbeat.md`](../../templates/11_heartbeat.md) (extended) |
